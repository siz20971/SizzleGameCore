...
namespace Sizzle.AbilitySystem.Behavior
{
    ...
    [NodeDescription(
        name: "Activate Ability (String)",
        description: "Activates an ability by tag string on the target AbilityProcessor and optionally waits until it finishes.",
        story: "Activate ability [AbilityTagName] on [Target]",
        category: "Action/Sizzle/Ability",
        id: "c3b8e090b2e54db2a95d4c0f53f4d102")]
    public partial class ActivateAbilityByStringAction : Action
    {
        ...
        private string m_resolvedTagName;
        ...
        protected override Status OnStart()
        {
            ...
            m_resolvedTagName = AbilityTagName != null ? AbilityTagName.Value : string.Empty;
            if (string.IsNullOrWhiteSpace(m_resolvedTagName))
            {
                LogFailure("AbilityTagName is empty.");
                return Status.Failure;
            }

            AbilityActivateResult result = m_processor.TryActivateAbility(m_resolvedTagName);
            ...
            m_context = m_processor.GetAbilityContext(new Sizzle.GameTagSystem.GameTag(m_resolvedTagName));
        ...
        protected override void OnEnd()
        {
            m_context = null;
            m_processor = null;
            m_resolvedTagName = string.Empty;
        }
    }
}